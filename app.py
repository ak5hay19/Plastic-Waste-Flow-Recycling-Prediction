...
def main():
    ...
    # Use no minimum weight for sampled data to get better network visualization
    # For full dataset, use min_weight=1000 to filter small flows
    ...
    # --- FINAL DASHBOARD LINK SECTION ---
    print("\n🚀 Main Dashboard:")
    
    # Get the directory where the script is running
    script_dir = Path(__file__).resolve().parent
    
    # Construct the full path to the main dashboard file
    ...
    if dashboard_path.exists():
        ...
        # Create clickable link for supported terminals
        ...
        print(f"   ✗ ERROR: 'main_dashboard.html' not found at {dashboard_path}")
        print(f"     Make sure you have saved main_dashboard.html in outputs/figures/")
    # --- END SECTION ---
